...
class Images:
    ...
    def init(self):
        ...
        glFramebufferTexture2DEXT(GL_FRAMEBUFFER_EXT, GL_COLOR_ATTACHMENT0_EXT, gl.GL_TEXTURE_2D, self.texture, 0)
	...
	# gl.glTexCoord2d(0, 0)
        # gl.glVertex2d(self.width*0.5, 0)
        # gl.glTexCoord2d(self.imageWidth, 0)
        # gl.glVertex2d(self.width, 0)
        # gl.glTexCoord2d(self.imageWidth, self.imageHeight)
        # gl.glVertex2d(self.width, self.height*0.5)
        # gl.glTexCoord2d(0, self.imageHeight)
        # gl.glVertex2d(self.width*0.5, self.height*0.5)
        # gl.glEnd()
	...
	gl.glDrawArrays(gl.GL_QUADS, 0, len(vertices))
        ...
        # gl.glTexCoord2d(0, self.imageHeight)
        # gl.glVertex2d(9, self.height)
        # gl.glEnd()

        gl.glFlush()

        # gl.glDrawBuffers(1, GL_COLOR_ATTACHMENT0_EXT)'''
