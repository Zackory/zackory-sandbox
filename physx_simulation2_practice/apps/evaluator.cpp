...
int main(int argc, char* argv[])
{
    ...
    // gown or simp
    simp_good.ReadData(string(PHYSX_ROOT_PATH)+"/Data/good/subject4/3.txt");
    simp_miss.ReadData(string(PHYSX_ROOT_PATH)+"/Data/miss/subject4/2.txt");
    simp_caught.ReadData(string(PHYSX_ROOT_PATH)+"/Data/caughtmiss/subject0/10.txt");
    //simp_good.ReadData("Data/simplified_good.txt");
    //simp_miss.ReadData("Data/simplified_miss.txt");
