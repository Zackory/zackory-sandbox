...
for iteration in xrange(n_iter):
    ...
    thetas = np.array([np.random.normal(mu, std, (batch_size,)) for mu, std in zip(theta_mean, theta_std)]).T
    ...
    do_episode(make_policy(theta_mean), env, num_steps, render=iteration>=90)
